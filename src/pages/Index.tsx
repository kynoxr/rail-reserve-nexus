  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#fdfcfb] to-[#e2d1c3] px-4">
      <header className="mb-12 text-center">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-200 font-medium animate-fade-in">Your journey begins here. Book trains, manage reservations, and explore routes with ease.</p>
      </header>
      <Card className="w-full max-w-md shadow-xl border-0 glass-morphism animate-scale-in">
        ...
        <CardContent className="flex flex-col items-center gap-4">
          <p className="text-gray-600 dark:text-gray-300 text-center">Ready to begin your railway adventure? Click below to start exploring.</p>
          <Button size="lg" className="w-full font-semibold animate-pulse">
            Book Tickets
          </Button>
        </CardContent>
      </Card>
